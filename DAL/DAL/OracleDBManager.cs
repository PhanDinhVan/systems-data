...
namespace System_Data
{
    ...
    {
        public static readonly string ConnectionStr = ConfigurationManager.ConnectionStrings["PKERP"].ConnectionString;
        ...
        public static DataTable Query(string strSql, OracleParameter[] parameters)
        {
            ...
            try
            {
                cmd = BuildSqlCommand(strSql, parameters, ConnectionStr);
                //cmd.BindByName = true;
                conn.Open();
        ...
        public static DataTable Query(string strSql, OracleParameter[] parameters, string connstr)
        {
            /* 2019-06-13 Tai Le (Thomas)
             */

            var LcConnstr = ConnectionStr;
        ...
        {
            return GetObjects<T>(commandText, commandType, parameters, ConnectionStr);
        }
        ...
        /// But has 1 more Argument : Connection_String ; if Connection_String is NULL (or empty) , use the default    ConnectionStr
        /// </summary>
        /// <typeparam name="T"></typeparam>
        ...
        {
            return GetObjects<T>(commandText, CommandType.Text, parameters, ConnectionStr, connectionTimeout);
        }
        ...
        {
            return GetObjectsByType<T>(commandText, commandType, parameters, ConnectionStr);
        }
